                            ...
                            <div class="item">
                                <div class="product-card">
                                        ...
                                        <div id="f1_container">
                                            <div id="f1_card" class="shadow">
                                                <div class="front face">
                                                    <img src="{{ asset('front_assets/images/ARP3514.jpg') }}"
                                    ...
                                    <div class="text-caption">
                                        ...
                                        <p> <span class="price-txt">Rs.1000</span> <span class="price-oveline">Rs.250</span>
                                            <span class="discount-text">30%</span></p>
                                        <p class="pro-rating">
