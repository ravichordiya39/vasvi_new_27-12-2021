...
@section('content')
                                ...
                                @foreach($banners as $banner)
                                    @if($loop->iteration==1)
                                        <div class="item active">
                                           <img style="max-width: 100%;" src="{{ $banner->photo->url}}" alt="Slider">
                                        </div>
                                    @else
                                        <div class="item">
                                           <img style="max-width: 100%;" src="{{ $banner->photo->url}}" alt="Slider">
                        ...
                        <div class="carousel-inner" role="listbox">
                            @if(count($banners)>0)
                                @foreach($banners as $banner)
                                    @if($loop->iteration==1)
                                        <div class="item active">
                                           <img style="max-width: 100%;" src="{{ asset('storage/banner/'.$banner->photo->thumb.'')}}" alt="Slider">
                                        </div>
                                    @else
                                        <div class="item">
                                           <img style="max-width: 100%;" src="{{ asset('storage/banner/'.$banner->photo->thumb.'')}}" alt="Slider">
    ...
    <section class="top-banner">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="side-img col-md-12">
                            <a href="{{ $mode->link ?? ''}}"><img height="90%" class="img-fluid" src="{{ asset('storage/bannerimages').'/'.$mode->image }}" onerror="javascript:this.src='{{asset('front_assets/images/fmix.jpg')}}'"
                                alt="women" /></a>
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="col-md-6">
                    <a href="{{ $thirdmodel->link ?? ''}}"><img style="height: 504px;" class="img-fluid" src="{{ asset('storage/bannerimages').'/'.$thirdmodel->image }}"
                    ...
                    @foreach ($models as $mode)
                        <div class="col-sm-6 col-xs-12">
                            <div class="catImg">
                                ...
                                <a href="{{ $mode->link ?? ''}}"><img src="{{ asset('storage/bannerimages').'/'.$mode->image }}" onerror="javascript:this.src='{{asset('front_assets/images/bestsle0.jpg')}}'" class="img-responsive"></a>
                            </div>
                        </div>
                        @endforeach
                    </div>
    ...
    <section>
        ...
        <a href="{{ $mode->link ?? ''}}"><section class="vasvi-offer-banner"><img src="{{ asset('storage/bannerimages').'/'.$fourmodel->image }}" alt="" /> </section></a>
        ...
        <div class="row justify-content-center ">
            <div class="col-lg-3 col-md-3">
                <div class="home-blog d-block">
                    <img class="img-fluid" src="{{ asset('front_assets/images/blog1.jpg') }}" alt="blog" />
            ...
            <div class="col-lg-3 col-md-3">
                <div class="home-blog d-block">
                    <img class="img-fluid" src="{{ asset('front_assets/images/blog2.jpg') }}" alt="blog" />
                    <div class="home-blog-content">
                        <div class="home-blog-title"><a href="#">Trends 2018</a></div>
                        <div class="home-blog-text">Lorem ipsum dolor sit amet, consectetur adipiscing Donec et.</div>
                    </div>
