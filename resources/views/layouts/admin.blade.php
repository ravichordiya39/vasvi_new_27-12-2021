...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    ...
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            ...
            {{-- <ul class="navbar-nav">
              <div class="nav-link" style="width : 50%;">
                 <div class="ticker-wrap">
                    <div class="ticker">
                      <div class="ticker__item">Please upload  product images with minimum sizes like maximum size 200kb to 300kb.</div>
                      <div class="ticker__item">Logo and favicon should be less in size like logo should be maximum 150kb and favicon should be maximum 50kb</div>
                      <div class="ticker__item">If you not taking care of uploading images the website will be slow day and day basic.</div>
