...
class ProductController extends Controller
{
    ...
    public function detail($slug)
    {
        ...
        $psizes = ProductVariation::where('product_id', $product->id)->groupBy('size_id')->pluck('size_id')->toArray();
      ...
      return view('store.products.detail', compact('info','psizes','sizes','colors','attributes','categories','category_str','attribute_values','trending','product','like'));
    }
}
